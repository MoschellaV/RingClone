...
import { Button, Stack, Text, AlertDialog, Box, ScrollView } from "native-base";
            ...
            <Stack space={4} w="70%" maxW="300px" mx="auto" flex={1} mt={30}>
                ...
                <AlertDialog leastDestructiveRef={cancelRef} isOpen={isOpen} onClose={onCloseDeleteModal}>
                    <AlertDialog.Content>
                        ...
                        <AlertDialog.Body>
                            This will remove all data related to this account. This action cannot be reversed. Deleted
